...
export default function EditDozentForm({ dozent }: { dozent: any }) {
    ...
    const deleteWithId = deleteDozent.bind(null, dozent.id_dozent);

    return (
        <div className="card max-w-2xl">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold">Dozent bearbeiten</h1>
            ...
            <form action={formAction} className="space-y-4">
                {/* WICHTIG: Richtige ID-Bezeichnung für das Backend */}
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="ort"
                        defaultValue={dozent.ort}
                        className="input-field"
                    />
                </div>

                <div className="flex justify-end gap-2 mt-6">
                    <Link href={`/dozenten/${dozent.id_dozent}`} className="px-4 py-2 border rounded text-gray-600 hover:bg-gray-50 flex items-center">
                        Abbrechen
                    </Link>
